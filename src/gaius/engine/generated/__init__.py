...
from .gaius_service_pb2 import (
    ...
    BacklogViewRow,
    BacklogViewResponse,
    NautilusStatusRequest,
    NautilusSessionRow,
    NautilusStatusResponse,
    # Coordination Activities view (2026-09-06)
    ThoughtsBriefRequest,
    ThoughtRow,
    ThoughtsBriefResponse,
    AgendaBriefRequest,
    AgendaBriefItem,
    AgendaBriefResponse,
    ...
    FmpSearchResponse,
    FmpEmployeesRequest,
    FmpEmployeesResponse,
    FmpCallRequest,
    FmpCallResponse,
    FmpListToolsRequest,
    FmpListToolsResponse,
    PrepareFmpWarehouseRequest,
    PrepareFmpWarehouseResponse,
    SummaryNote,
    SummaryIndexRequest,
