...
class GaiusServiceStub:
    ...
    AgendaBrief: grpc.UnaryUnaryMultiCallable[gaius_service_pb2.AgendaBriefRequest, gaius_service_pb2.AgendaBriefResponse]
...
class GaiusServiceAsyncStub(GaiusServiceStub):
    ...
    """(2026-09-07) /thoughts default: the Brief the cognition cycle wrote — instant, no model call."""
    AgendaBrief: grpc.aio.UnaryUnaryMultiCallable[gaius_service_pb2.AgendaBriefRequest, gaius_service_pb2.AgendaBriefResponse]  # type: ignore[assignment]
...
class GaiusServiceServicer(metaclass=abc.ABCMeta):
    ...
    def AgendaBrief(
        self,
        request: gaius_service_pb2.AgendaBriefRequest,
        context: _ServicerContext,
    ) -> typing.Union[gaius_service_pb2.AgendaBriefResponse, collections.abc.Awaitable[gaius_service_pb2.AgendaBriefResponse]]: ...
