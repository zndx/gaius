...
XAI_INPUT_PRICE_PER_1K = 0.005  # $5 per 1M input tokens
XAI_OUTPUT_PRICE_PER_1K = 0.015  # $15 per 1M output tokens
...
Given analyses of recent SEC filings for a company, produce a comprehensive investment thesis including:
...
{{
    ...
    "valuation_notes": "<brief valuation perspective>"
}}"""
...
class ProspectsAnalyzer:
    ...
    async def analyze_filing(
        ...
        user_content = FILING_ANALYSIS_USER_TEMPLATE.format(
            ...
            filing_content=filing_content[:15000],  # Truncate to ~4K tokens
        )
