...
OBJECTIVES: dict[str, ObjectiveSpec] = {
    ...
    "content_currency": ObjectiveSpec(
        ...
        "signals-protocol (pending), Gaius adopts Airflow for DAG execution "
        "and/or Sensors per Airflow best practices, and the intent read here "
        "moves from cron.job to the DAG schedule and sensor timeouts. "
