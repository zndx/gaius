...
The Gaius implementation targets grok-build via `grok agent stdio` (default: local thinking Qwen3.8-27B; escalate with a Grok subscription), enabling autonomous investigation and remediation of health incidents.
...
Tier 2 escalates to the ACP agent (grok-build) for investigation and **framework evolution**. This tier uniquely has the capability to:
...
Generated by Gaius ACP (grok-build)
