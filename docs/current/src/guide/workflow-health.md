...
If `/health fix` does not resolve the issue, the Health Observer can escalate via ACP (Agent Client Protocol) to grok-build for deeper analysis. This happens automatically when:
