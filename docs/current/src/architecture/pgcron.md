...
| `20260817000001_weekly_signals_summary_cron` | Weekly Signals Summary (S2S remotes) | Monday 15:00 UTC (superseded) |
| `20260913000001_weekly_signals_summary_friday_denver` | Weekly Signals Summary | Friday 06:00 America/Denver (Airflow); pg_cron twin inactive |
