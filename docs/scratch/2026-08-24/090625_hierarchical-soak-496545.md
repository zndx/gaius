# Hierarchical soak tick (09:06Z)

Sampler still C++ (`pid 2989721`, ~4.9 h, `kudu_ok`). Hour **496545**
hot (~6 min jsonl). Impala FE already `IMPALA_BUILD_OK`. Do not analog
— not closed (10:00Z).

## Proven (no fake rows)

- Live C++ upsert of jsonl hour 496545: **2196** rows (366 ticks).
