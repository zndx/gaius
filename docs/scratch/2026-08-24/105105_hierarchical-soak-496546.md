# Hierarchical soak tick (10:51Z)

Sampler still C++ (`pid 2989721`, ~6.6 h, `kudu_ok`). Hour **496546**
hot (~50 min jsonl). Impala FE already `IMPALA_BUILD_OK`. Do not analog
— not closed (11:00Z). Hour **496545** already Iceberg.

## Proven (no fake rows)

- Live C++ upsert of jsonl hour 496546: **18180** rows (3030 ticks).
